...
spurious_proportions_random, balanced_accuracies_random = sort_and_unpack(
    spurious_proportions_random, balanced_accuracies_random
)
spurious_proportions_end, balanced_accuracies_end = sort_and_unpack(
    spurious_proportions_end, balanced_accuracies_end
)
spurious_proportions_beginning, balanced_accuracies_beginning = sort_and_unpack(
    spurious_proportions_beginning, balanced_accuracies_beginning
)

spurious_proportions_random2, balanced_accuracies_random2 = sort_and_unpack(
    spurious_proportions_random2, balanced_accuracies_random2
)
spurious_proportions_end2, balanced_accuracies_end2 = sort_and_unpack(
    spurious_proportions_end2, balanced_accuracies_end2
)
spurious_proportions_beginning2, balanced_accuracies_beginning2 = sort_and_unpack(
    spurious_proportions_beginning2, balanced_accuracies_beginning2
)

spurious_proportions_random32, balanced_accuracies_random32 = sort_and_unpack(
    spurious_proportions_random32, balanced_accuracies_random32
)
spurious_proportions_end32, balanced_accuracies_end32 = sort_and_unpack(
    spurious_proportions_end32, balanced_accuracies_end32
)
spurious_proportions_beginning32, balanced_accuracies_beginning32 = sort_and_unpack(
    spurious_proportions_beginning32, balanced_accuracies_beginning32
)
...
plot_data(
    spurious_proportions_end, balanced_accuracies_end, "End", linestyle="-.", marker="d"
)
plot_data(
    spurious_proportions_beginning,
    balanced_accuracies_beginning,
